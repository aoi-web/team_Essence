...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-blue-900 text-white shadow-md">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/images/15.PNG" alt="SkyOps Logo" className="h-12 w-12" /> {/* Adjusted the size */}
      ...
      <main className="flex-1 bg-gradient-to-b from-blue-600 to-white p-8">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold text-white text-center mb-6">Comprehensive Airline Management Solutions</h1>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-gray-200 md:text-xl">
                  Streamline your airline operations, optimize hub management, and enhance passenger experience with our integrated platform.
                </p>
              </div>
            ...
            <div className="hidden lg:block">
              <div className="mx-auto aspect-video overflow-hidden rounded-xl bg-muted/50 object-cover">
                <img
                  ...
                  className="w-full"
                  height="550"
                  src="/images/10.jpg" // Update this URL
                  width="1000"
                />
              </div>
            </div>
          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="mx-auto aspect-video overflow-hidden rounded-xl bg-muted/50 object-cover">
              <img 
                ...
                className="w-full"
                height="310"
                src="/images/4.jpg" // Update this URL
                width="550"
              />
            </div>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="mx-auto aspect-video overflow-hidden rounded-xl bg-muted/50 object-cover order-last lg:order-first">
              <img
                ...
                className="w-full"
                height="310"
                src="/images/5.jpg" // Update this URL
                width="550"
              />
            </div>
            <div className="flex flex-col justify-center space-y-4">
      ...
      <footer className="w-full bg-blue-900 text-white py-6 mt-10">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-sm text-gray-300">© 2025 AeroManage. All rights reserved.</p>
